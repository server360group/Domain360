...
const $global = function () {
  ...
  */
  ...
  /**
   * Recommended values for light and dark mode for {@link @ahtmlui/web-components#baseLayerLuminance}.
   *
   * @public
   */
  ...
  /**
   * The AHTML Accordion Item Element. Implements {@link @microsoft/fast-foundation#AccordionItem},
   * {@link @microsoft/fast-foundation#accordionItemTemplate}
   *
   *
   * @public
   * @remarks
   * HTML Element: \<ahtml-accordion-item\>
   */
  const ahtmlAccordionItem = AccordionItem.compose({
  ...
  /**
   * The AHTML Accordion Element. Implements {@link @microsoft/fast-foundation#Accordion},
   * {@link @microsoft/fast-foundation#accordionTemplate}
   *
   *
   * @public
   * @remarks
   * HTML Element: \<ahtml-accordion\>
   */
  const ahtmlAccordion = Accordion.compose({
    baseName: 'accordion',
  ...
  ***************************************************************************** */
  ...
  /**
   * The AHTML Anchor Element. Implements {@link @microsoft/fast-foundation#Anchor},
   * {@link @microsoft/fast-foundation#anchorTemplate}
   *
   *
   * @public
   * @remarks
   * HTML Element: \<ahtml-anchor\>
   *
   * {@link https://developer.mozilla.org/en-US/docs/Web/API/ShadowRoot/delegatesFocus | delegatesFocus}
   */
  const ahtmlAnchor = Anchor.compose({
    baseName: 'anchor',
    baseClass: Anchor$1,
  ...
  /**
   * The AHTML AnchoredRegion Element. Implements {@link @microsoft/fast-foundation#AnchoredRegion},
   * {@link @microsoft/fast-foundation#anchoredRegionTemplate}
   *
   *
   * @beta
   * @remarks
   * HTML Element: \<ahtml-anchored-region\>
   */
  const ahtmlAnchoredRegion = AnchoredRegion.compose({
  ...
  /**
   * The AHTML Badge Element. Implements {@link @microsoft/fast-foundation#Badge},
   * {@link @microsoft/fast-foundation#badgeTemplate}
   *
   *
   * @public
   * @remarks
   * HTML Element: \<ahtml-badge\>
   */
  const ahtmlBadge = Badge.compose({
    baseName: 'badge',
    baseClass: Badge$1,
  ...
  /**
   * The AHTML Breadcrumb Element. Implements {@link @microsoft/fast-foundation#Breadcrumb},
   * {@link @microsoft/fast-foundation#breadcrumbTemplate}
   *
   *
   * @public
   * @remarks
   * HTML Element: \<ahtml-breadcrumb\>
   */
  const ahtmlBreadcrumb = Breadcrumb.compose({
    baseName: 'breadcrumb',
  ...
  /**
   * The AHTML BreadcrumbItem Element. Implements {@link @microsoft/fast-foundation#BreadcrumbItem},
   * {@link @microsoft/fast-foundation#breadcrumbItemTemplate}
   *
   *
   * @public
   * @remarks
   * HTML Element: \<ahtml-breadcrumb-item\>
   */
  const ahtmlBreadcrumbItem = BreadcrumbItem.compose({
  ...
  /**
   * The AHTML Button Element. Implements {@link @microsoft/fast-foundation#Button},
   * {@link @microsoft/fast-foundation#buttonTemplate}
   *
   *
   * @public
   * @remarks
   * HTML Element: \<ahtml-button\>
   *
   * {@link https://developer.mozilla.org/en-US/docs/Web/API/ShadowRoot/delegatesFocus | delegatesFocus}
   */
  const ahtmlButton = Button.compose({
    baseName: 'button',
    baseClass: Button$1,
  ...
  /**
   * The AHTML Calendar Element. Implements {@link @microsoft/fast-foundation#Calendar},
   * {@link @microsoft/fast-foundation#calendarTemplate}
   *
   * @public
   * @remarks
   * HTML Element \<ahtml-calendar\>
   */
  const ahtmlCalendar = Calendar.compose({
    baseName: 'calendar',
  ...
  /**
   * The AHTML Card Element. Implements {@link @microsoft/fast-foundation#Card},
   * {@link @microsoft/fast-foundation#CardTemplate}
   *
   *
   * @public
   * @remarks
   * HTML Element: \<ahtml-card\>
   */
  const ahtmlCard = Card.compose({
    baseName: 'card',
    baseClass: Card$1,
  ...
  /**
   * The AHTML Checkbox Element. Implements {@link @microsoft/fast-foundation#Checkbox},
   * {@link @microsoft/fast-foundation#checkboxTemplate}
   *
   *
   * @public
   * @remarks
   * HTML Element: \<ahtml-checkbox\>
   */
  const ahtmlCheckbox = Checkbox.compose({
    baseName: 'checkbox',
  ...
  /**
   * The AHTML Combobox Custom Element. Implements {@link @microsoft/fast-foundation#Combobox},
   * {@link @microsoft/fast-foundation#comboboxTemplate}
   *
   * @public
   * @remarks
   * HTML Element: \<ahtml-combobox\>
   *
   */
  const ahtmlCombobox = Combobox.compose({
    baseName: 'combobox',
  ...
  /**
   * The AHTML Data Grid Cell Element.
   *
   * @public
   * @remarks
   * HTML Element: \<ahtml-data-grid-cell\>
   */
  const ahtmlDataGridCell = DataGridCell.compose({
  ...
  /**
   * The AHTML Data Grid Row Element.
   *
   * @public
   * @remarks
   * HTML Element: \<ahtml-data-grid-row\>
   */
  const ahtmlDataGridRow = DataGridRow.compose({
  ...
  /**
   * The AHTML Data Grid Element.
   *
   * @public
   * @remarks
   * HTML Element: \<ahtml-data-grid\>
   */
  const ahtmlDataGrid = DataGrid.compose({
    baseName: 'data-grid',
  ...
  /**
   * The AHTML DesignSystemProvider Element.
   * @public
   */
  class DesignSystemProvider extends FoundationElement {
    constructor() {
      super();
      /**
       * Used to instruct the AHTMLDesignSystemProvider
  ...
  /**
   * The AHTML Design System Provider Element.
   *
   * @public
   * @remarks
   * HTML Element: \<ahtml-design-system-provider\>
   */
  const ahtmlDesignSystemProvider = DesignSystemProvider.compose({
  ...
  /**
   * The AHTML Dialog Element. Implements {@link @microsoft/fast-foundation#Dialog},
   * {@link @microsoft/fast-foundation#dialogTemplate}
   *
   *
   * @public
   * @remarks
   * HTML Element: \<ahtml-dialog\>
   */
  const ahtmlDialog = Dialog.compose({
    baseName: 'dialog',
  ...
  /**
   * The AHTML Divider Element. Implements {@link @microsoft/fast-foundation#Divider},
   * {@link @microsoft/fast-foundation#dividerTemplate}
   *
   *
   * @public
   * @remarks
   * HTML Element: \<ahtml-divider\>
   */
  const ahtmlDivider = Divider.compose({
    baseName: 'divider',
  ...
  /**
   * The AHTML Flipper Element. Implements {@link @microsoft/fast-foundation#Flipper},
   * {@link @microsoft/fast-foundation#flipperTemplate}
   *
   *
   * @public
   * @remarks
   * HTML Element: \<ahtml-flipper\>
   */
  const ahtmlFlipper = Flipper.compose({
    baseName: 'flipper',
  ...
  /**
   * The AHTML HorizontalScroll Element. Implements {@link @microsoft/fast-foundation#HorizontalScroll},
   * {@link @microsoft/fast-foundation#horizontalScrollTemplate}
   *
   *
   * @public
   * @remarks
   * HTML Element: \<ahtml-horizontal-scroll\>
   */
  const ahtmlHorizontalScroll = HorizontalScroll.compose({
    baseName: 'horizontal-scroll',
    baseClass: HorizontalScroll$1,
    template: horizontalScrollTemplate,
    styles: horizontalScrollStyles$1,
    nextFlipper: html`<ahtml-flipper @click="${x => x.scrollToNext()}" aria-hidden="${x => x.flippersHiddenFromAT}"></ahtml-flipper>`,
    previousFlipper: html`<ahtml-flipper @click="${x => x.scrollToPrevious()}" direction="previous" aria-hidden="${x => x.flippersHiddenFromAT}"></ahtml-flipper>`
  });
  /**
  ...
  /**
   * The AHTML listbox Custom Element. Implements, {@link @microsoft/fast-foundation#Listbox}
   * {@link @microsoft/fast-foundation#listboxTemplate}
   *
   *
   * @public
   * @remarks
   * HTML Element: \<ahtml-listbox\>
   *
   */
  const ahtmlListbox = Listbox.compose({
    baseName: 'listbox',
  ...
  /**
   * The AHTML option Custom Element. Implements {@link @microsoft/fast-foundation#ListboxOption}
   * {@link @microsoft/fast-foundation#listboxOptionTemplate}
   *
   *
   * @public
   * @remarks
   * HTML Element: \<ahtml-option\>
   *
   */
  const ahtmlOption = ListboxOption.compose({
    baseName: 'option',
  ...
  /**
   * The AHTML Menu Element. Implements {@link @microsoft/fast-foundation#Menu},
   * {@link @microsoft/fast-foundation#menuTemplate}
   *
   *
   * @public
   * @remarks
   * HTML Element: \<ahtml-menu\>
   */
  const ahtmlMenu = Menu.compose({
    baseName: 'menu',
    baseClass: Menu$1,
  ...
  /**
   * The AHTML Menu Item Element. Implements {@link @microsoft/fast-foundation#MenuItem},
   * {@link @microsoft/fast-foundation#menuItemTemplate}
   *
   *
   * @public
   * @remarks
   * HTML Element: \<ahtml-menu-item\>
   */
  const ahtmlMenuItem = MenuItem.compose({
    baseName: 'menu-item',
  ...
  /**
   * The AHTML Number Field Custom Element. Implements {@link @microsoft/fast-foundation#NumberField},
   * {@link @microsoft/fast-foundation#numberFieldTemplate}
   *
   *
   * @public
   * @remarks
   * HTML Element: \<ahtml-number-field\>
   *
   * {@link https://developer.mozilla.org/en-US/docs/Web/API/ShadowRoot/delegatesFocus | delegatesFocus}
   */
  const ahtmlNumberField = NumberField.compose({
  ...
  /**
   * The AHTML Progress Element. Implements {@link @microsoft/fast-foundation#BaseProgress},
   * {@link @microsoft/fast-foundation#progressTemplate}
   *
   *
   * @public
   * @remarks
   * HTML Element: \<ahtml-progress\>
   */
  const ahtmlProgress = Progress.compose({
    baseName: 'progress',
  ...
  /**
   * The AHTML Progress Ring Element. Implements {@link @microsoft/fast-foundation#BaseProgress},
   * {@link @microsoft/fast-foundation#progressRingTemplate}
   *
   *
   * @public
   * @remarks
   * HTML Element: \<ahtml-progress-ring\>
   */
  const ahtmlProgressRing = ProgressRing.compose({
  ...
  /**
   * The AHTML Radio Element. Implements {@link @microsoft/fast-foundation#Radio},
   * {@link @microsoft/fast-foundation#radioTemplate}
   *
   *
   * @public
   * @remarks
   * HTML Element: \<ahtml-radio\>
   */
  const ahtmlRadio = Radio.compose({
    baseName: 'radio',
  ...
  /**
   * The AHTML Radio Group Element. Implements {@link @microsoft/fast-foundation#RadioGroup},
   * {@link @microsoft/fast-foundation#radioGroupTemplate}
   *
   *
   * @public
   * @remarks
   * HTML Element: \<ahtml-radio-group\>
   */
  const ahtmlRadioGroup = RadioGroup.compose({
  ...
  /**
   * The AHTML Search Custom Element. Implements {@link @microsoft/fast-foundation#Search},
   * {@link @microsoft/fast-foundation#searchTemplate}
   *
   *
   * @public
   * @remarks
   * HTML Element: \<ahtml-search\>
   *
   * {@link https://developer.mozilla.org/en-US/docs/Web/API/ShadowRoot/delegatesFocus | delegatesFocus}
   */
  const ahtmlSearch = Search.compose({
    baseName: 'search',
    baseClass: Search$1,
  ...
  /**
   * The AHTML select Custom Element. Implements, {@link @microsoft/fast-foundation#Select}
   * {@link @microsoft/fast-foundation#selectTemplate}
   *
   *
   * @public
   * @remarks
   * HTML Element: \<ahtml-select\>
   *
   */
  const ahtmlSelect = Select.compose({
    baseName: 'select',
    baseClass: Select$1,
  ...
  /**
   * The AHTML Skeleton Element. Implements {@link @microsoft/fast-foundation#Skeleton},
   * {@link @microsoft/fast-foundation#skeletonTemplate}
   *
   *
   * @public
   * @remarks
   * HTML Element: \<ahtml-skeleton\>
   */
  const ahtmlSkeleton = Skeleton.compose({
    baseName: 'skeleton',
  ...
  /**
   * The AHTML Slider Custom Element. Implements {@link @microsoft/fast-foundation#(Slider:class)},
   * {@link @microsoft/fast-foundation#sliderTemplate}
   *
   *
   * @public
   * @remarks
   * HTML Element: \<ahtml-slider\>
   */
  const ahtmlSlider = Slider.compose({
    baseName: 'slider',
  ...
  /**
   * The AHTML Slider Label Custom Element. Implements {@link @microsoft/fast-foundation#SliderLabel},
   * {@link @microsoft/fast-foundation#sliderLabelTemplate}
   *
   *
   * @public
   * @remarks
   * HTML Element: \<ahtml-slider-label\>
   */
  const ahtmlSliderLabel = SliderLabel.compose({
  ...
  /**
   * The AHTML Switch Custom Element. Implements {@link @microsoft/fast-foundation#Switch},
   * {@link @microsoft/fast-foundation#SwitchTemplate}
   *
   *
   * @public
   * @remarks
   * HTML Element: \<ahtml-switch\>
   */
  const ahtmlSwitch = Switch.compose({
    baseName: 'switch',
  ...
  /**
   * The AHTML Tab Custom Element. Implements {@link @microsoft/fast-foundation#Tab},
   * {@link @microsoft/fast-foundation#tabTemplate}
   *
   *
   * @public
   * @remarks
   * HTML Element: \<ahtml-tab\>
   */
  const ahtmlTab = Tab.compose({
    baseName: 'tab',
  ...
  /**
   * The AHTML Tab Panel Custom Element. Implements {@link @microsoft/fast-foundation#TabPanel},
   * {@link @microsoft/fast-foundation#tabPanelTemplate}
   *
   *
   * @public
   * @remarks
   * HTML Element: \<ahtml-tab-panel\>
   */
  const ahtmlTabPanel = TabPanel.compose({
    baseName: 'tab-panel',
  ...
  /**
   * The AHTML Tabs Custom Element. Implements {@link @microsoft/fast-foundation#Tabs},
   * {@link @microsoft/fast-foundation#tabsTemplate}
   *
   *
   * @public
   * @remarks
   * HTML Element: \<ahtml-tabs\>
   */
  const ahtmlTabs = Tabs.compose({
    baseName: 'tabs',
  ...
  /**
   * The AHTML Text Area Custom Element. Implements {@link @microsoft/fast-foundation#TextArea},
   * {@link @microsoft/fast-foundation#textAreaTemplate}
   *
   *
   * @public
   * @remarks
   * HTML Element: \<ahtml-text-area\>
   *
   * {@link https://developer.mozilla.org/en-US/docs/Web/API/ShadowRoot/delegatesFocus | delegatesFocus}
   */
  const ahtmlTextArea = TextArea.compose({
    baseName: 'text-area',
  ...
  /**
   * The AHTML Text Field Custom Element. Implements {@link @microsoft/fast-foundation#TextField},
   * {@link @microsoft/fast-foundation#textFieldTemplate}
   *
   *
   * @public
   * @remarks
   * HTML Element: \<ahtml-text-field\>
   *
   * {@link https://developer.mozilla.org/en-US/docs/Web/API/ShadowRoot/delegatesFocus | delegatesFocus}
   */
  const ahtmlTextField = TextField.compose({
    baseName: 'text-field',
  ...
  /**
   * The AHTML toolbar class
   * @internal
   */
  class Toolbar extends Toolbar$1 {}
  /**
   * The AHTML Toolbar Custom Element. Implements {@link @microsoft/fast-foundation#Toolbar},
   * {@link @microsoft/fast-foundation#toolbarTemplate}
   *
   *
   * @public
   * @remarks
   * HTML Element: \<ahtml-toolbar\>
   */
  const ahtmlToolbar = Toolbar.compose({
    baseName: 'toolbar',
    baseClass: Toolbar$1,
  ...
  /**
   * The AHTML Tooltip Custom Element. Implements {@link @microsoft/fast-foundation#Tooltip},
   * {@link @microsoft/fast-foundation#tooltipTemplate}
   *
   *
   * @public
   * @remarks
   * HTML Element: \<ahtml-tooltip\>
   */
  const ahtmlTooltip = Tooltip.compose({
    baseName: 'tooltip',
    baseClass: Tooltip$1,
  ...
  /**
   * The AHTML tree view Custom Element. Implements, {@link @microsoft/fast-foundation#TreeView}
   * {@link @microsoft/fast-foundation#treeViewTemplate}
   *
   *
   * @public
   * @remarks
   * HTML Element: \<ahtml-tree-view\>
   *
   */
  const ahtmlTreeView = TreeView.compose({
    baseName: 'tree-view',
  ...
  /* The french fry background needs to be calculated based on the selected background state for this control.
      We currently have no way of changing that, so setting to accent-foreground-rest for the time being */''} background:${accentFillRest};border-radius:calc(${controlCornerRadius} * 1px)}::slotted(ahtml-tree-item){--tree-item-nested-width:1em;--expand-collapse-button-nested-width:calc(${heightNumber} * -1px)}`.withBehaviors(new DirectionalStyleSheetBehavior(ltr, rtl), forcedColorsStylesheetBehavior(css`
  ...
  /**
   * The AHTML tree item Custom Element. Implements, {@link @microsoft/fast-foundation#TreeItem}
   * {@link @microsoft/fast-foundation#treeItemTemplate}
   *
   *
   * @public
   * @remarks
   * HTML Element: \<ahtml-tree-item\>
   *
   */
  const ahtmlTreeItem = TreeItem.compose({
    baseName: 'tree-item',
  ...
  const allComponents = {
    ...
    ahtmlDataGridCell,
    ahtmlDataGridRow,
    ahtmlDesignSystemProvider,
    ahtmlDialog,
    ahtmlDivider,
    ahtmlFlipper,
    ahtmlHorizontalScroll,
    ahtmlListbox,
    ahtmlOption,
    ahtmlMenu,
    ahtmlMenuItem,
