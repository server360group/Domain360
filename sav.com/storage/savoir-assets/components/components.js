...
const $global = function () {
  ...
  */
  ...
  /**
   * Recommended values for light and dark mode for {@link @sevoltui/web-components#baseLayerLuminance}.
   *
   * @public
   */
  ...
  // Typography values
  /** @public */
  const bodyFont = create('body-font').withDefault('sans-serif');
  /** @public */
  ...
  /**
   * The Sevolt Accordion Item Element. Implements {@link @microsoft/fast-foundation#AccordionItem},
   * {@link @microsoft/fast-foundation#accordionItemTemplate}
   *
   *
   * @public
   * @remarks
   * HTML Element: \<sevolt-accordion-item\>
   */
  const sevoltAccordionItem = AccordionItem.compose({
  ...
  /**
   * The Sevolt Accordion Element. Implements {@link @microsoft/fast-foundation#Accordion},
   * {@link @microsoft/fast-foundation#accordionTemplate}
   *
   *
   * @public
   * @remarks
   * HTML Element: \<sevolt-accordion\>
   */
  const sevoltAccordion = Accordion.compose({
    baseName: 'accordion',
  ...
  ***************************************************************************** */
  ...
  /**
   * The Sevolt Anchor Element. Implements {@link @microsoft/fast-foundation#Anchor},
   * {@link @microsoft/fast-foundation#anchorTemplate}
   *
   *
   * @public
   * @remarks
   * HTML Element: \<sevolt-anchor\>
   *
   * {@link https://developer.mozilla.org/en-US/docs/Web/API/ShadowRoot/delegatesFocus | delegatesFocus}
   */
  const sevoltAnchor = Anchor.compose({
    baseName: 'anchor',
    baseClass: Anchor$1,
  ...
  /**
   * The Sevolt AnchoredRegion Element. Implements {@link @microsoft/fast-foundation#AnchoredRegion},
   * {@link @microsoft/fast-foundation#anchoredRegionTemplate}
   *
   *
   * @beta
   * @remarks
   * HTML Element: \<sevolt-anchored-region\>
   */
  const sevoltAnchoredRegion = AnchoredRegion.compose({
  ...
  /**
   * The Sevolt Badge Element. Implements {@link @microsoft/fast-foundation#Badge},
   * {@link @microsoft/fast-foundation#badgeTemplate}
   *
   *
   * @public
   * @remarks
   * HTML Element: \<sevolt-badge\>
   */
  const sevoltBadge = Badge.compose({
    baseName: 'badge',
    baseClass: Badge$1,
  ...
  /**
   * The Sevolt Breadcrumb Element. Implements {@link @microsoft/fast-foundation#Breadcrumb},
   * {@link @microsoft/fast-foundation#breadcrumbTemplate}
   *
   *
   * @public
   * @remarks
   * HTML Element: \<sevolt-breadcrumb\>
   */
  const sevoltBreadcrumb = Breadcrumb.compose({
    baseName: 'breadcrumb',
  ...
  /**
   * The Sevolt BreadcrumbItem Element. Implements {@link @microsoft/fast-foundation#BreadcrumbItem},
   * {@link @microsoft/fast-foundation#breadcrumbItemTemplate}
   *
   *
   * @public
   * @remarks
   * HTML Element: \<sevolt-breadcrumb-item\>
   */
  const sevoltBreadcrumbItem = BreadcrumbItem.compose({
  ...
  /**
   * The Sevolt Button Element. Implements {@link @microsoft/fast-foundation#Button},
   * {@link @microsoft/fast-foundation#buttonTemplate}
   *
   *
   * @public
   * @remarks
   * HTML Element: \<sevolt-button\>
   *
   * {@link https://developer.mozilla.org/en-US/docs/Web/API/ShadowRoot/delegatesFocus | delegatesFocus}
   */
  const sevoltButton = Button.compose({
    baseName: 'button',
    baseClass: Button$1,
  ...
  /**
   * The Sevolt Calendar Element. Implements {@link @microsoft/fast-foundation#Calendar},
   * {@link @microsoft/fast-foundation#calendarTemplate}
   *
   * @public
   * @remarks
   * HTML Element \<sevolt-calendar\>
   */
  const sevoltCalendar = Calendar.compose({
    baseName: 'calendar',
  ...
  /**
   * The Sevolt Card Element. Implements {@link @microsoft/fast-foundation#Card},
   * {@link @microsoft/fast-foundation#CardTemplate}
   *
   *
   * @public
   * @remarks
   * HTML Element: \<sevolt-card\>
   */
  const sevoltCard = Card.compose({
    baseName: 'card',
    baseClass: Card$1,
  ...
  /**
   * The Sevolt Checkbox Element. Implements {@link @microsoft/fast-foundation#Checkbox},
   * {@link @microsoft/fast-foundation#checkboxTemplate}
   *
   *
   * @public
   * @remarks
   * HTML Element: \<sevolt-checkbox\>
   */
  const sevoltCheckbox = Checkbox.compose({
    baseName: 'checkbox',
  ...
  /**
   * The Sevolt Combobox Custom Element. Implements {@link @microsoft/fast-foundation#Combobox},
   * {@link @microsoft/fast-foundation#comboboxTemplate}
   *
   * @public
   * @remarks
   * HTML Element: \<sevolt-combobox\>
   *
   */
  const sevoltCombobox = Combobox.compose({
    baseName: 'combobox',
  ...
  /**
   * The Sevolt Data Grid Cell Element.
   *
   * @public
   * @remarks
   * HTML Element: \<sevolt-data-grid-cell\>
   */
  const sevoltDataGridCell = DataGridCell.compose({
  ...
  /**
   * The Sevolt Data Grid Row Element.
   *
   * @public
   * @remarks
   * HTML Element: \<sevolt-data-grid-row\>
   */
  const sevoltDataGridRow = DataGridRow.compose({
  ...
  /**
   * The Sevolt Data Grid Element.
   *
   * @public
   * @remarks
   * HTML Element: \<sevolt-data-grid\>
   */
  const sevoltDataGrid = DataGrid.compose({
    baseName: 'data-grid',
  ...
  /**
   * The Sevolt DesignSystemProvider Element.
   * @public
   */
  class DesignSystemProvider extends FoundationElement {
    constructor() {
      super();
      /**
       * Used to instruct the SevoltDesignSystemProvider
  ...
  /**
   * The Sevolt Design System Provider Element.
   *
   * @public
   * @remarks
   * HTML Element: \<sevolt-design-system-provider\>
   */
  const sevoltDesignSystemProvider = DesignSystemProvider.compose({
  ...
  /**
   * The Sevolt Dialog Element. Implements {@link @microsoft/fast-foundation#Dialog},
   * {@link @microsoft/fast-foundation#dialogTemplate}
   *
   *
   * @public
   * @remarks
   * HTML Element: \<sevolt-dialog\>
   */
  const sevoltDialog = Dialog.compose({
    baseName: 'dialog',
  ...
  /**
   * The Sevolt Divider Element. Implements {@link @microsoft/fast-foundation#Divider},
   * {@link @microsoft/fast-foundation#dividerTemplate}
   *
   *
   * @public
   * @remarks
   * HTML Element: \<sevolt-divider\>
   */
  const sevoltDivider = Divider.compose({
    baseName: 'divider',
  ...
  /**
   * The Sevolt Flipper Element. Implements {@link @microsoft/fast-foundation#Flipper},
   * {@link @microsoft/fast-foundation#flipperTemplate}
   *
   *
   * @public
   * @remarks
   * HTML Element: \<sevolt-flipper\>
   */
  const sevoltFlipper = Flipper.compose({
    baseName: 'flipper',
  ...
  /**
   * The Sevolt HorizontalScroll Element. Implements {@link @microsoft/fast-foundation#HorizontalScroll},
   * {@link @microsoft/fast-foundation#horizontalScrollTemplate}
   *
   *
   * @public
   * @remarks
   * HTML Element: \<sevolt-horizontal-scroll\>
   */
  const sevoltHorizontalScroll = HorizontalScroll.compose({
    baseName: 'horizontal-scroll',
    baseClass: HorizontalScroll$1,
    template: horizontalScrollTemplate,
    styles: horizontalScrollStyles$1,
    nextFlipper: html`<sevolt-flipper @click="${x => x.scrollToNext()}" aria-hidden="${x => x.flippersHiddenFromAT}"></sevolt-flipper>`,
    previousFlipper: html`<sevolt-flipper @click="${x => x.scrollToPrevious()}" direction="previous" aria-hidden="${x => x.flippersHiddenFromAT}"></sevolt-flipper>`
  });
  /**
  ...
  /**
   * The Sevolt listbox Custom Element. Implements, {@link @microsoft/fast-foundation#Listbox}
   * {@link @microsoft/fast-foundation#listboxTemplate}
   *
   *
   * @public
   * @remarks
   * HTML Element: \<sevolt-listbox\>
   *
   */
  const sevoltListbox = Listbox.compose({
    baseName: 'listbox',
  ...
  /**
   * The Sevolt option Custom Element. Implements {@link @microsoft/fast-foundation#ListboxOption}
   * {@link @microsoft/fast-foundation#listboxOptionTemplate}
   *
   *
   * @public
   * @remarks
   * HTML Element: \<sevolt-option\>
   *
   */
  const sevoltOption = ListboxOption.compose({
    baseName: 'option',
  ...
  /**
   * The Sevolt Menu Element. Implements {@link @microsoft/fast-foundation#Menu},
   * {@link @microsoft/fast-foundation#menuTemplate}
   *
   *
   * @public
   * @remarks
   * HTML Element: \<sevolt-menu\>
   */
  const sevoltMenu = Menu.compose({
    baseName: 'menu',
    baseClass: Menu$1,
  ...
  /**
   * The Sevolt Menu Item Element. Implements {@link @microsoft/fast-foundation#MenuItem},
   * {@link @microsoft/fast-foundation#menuItemTemplate}
   *
   *
   * @public
   * @remarks
   * HTML Element: \<sevolt-menu-item\>
   */
  const sevoltMenuItem = MenuItem.compose({
    baseName: 'menu-item',
  ...
  /**
   * The Sevolt Number Field Custom Element. Implements {@link @microsoft/fast-foundation#NumberField},
   * {@link @microsoft/fast-foundation#numberFieldTemplate}
   *
   *
   * @public
   * @remarks
   * HTML Element: \<sevolt-number-field\>
   *
   * {@link https://developer.mozilla.org/en-US/docs/Web/API/ShadowRoot/delegatesFocus | delegatesFocus}
   */
  const sevoltNumberField = NumberField.compose({
  ...
  /**
   * The Sevolt Progress Element. Implements {@link @microsoft/fast-foundation#BaseProgress},
   * {@link @microsoft/fast-foundation#progressTemplate}
   *
   *
   * @public
   * @remarks
   * HTML Element: \<sevolt-progress\>
   */
  const sevoltProgress = Progress.compose({
    baseName: 'progress',
  ...
  /**
   * The Sevolt Progress Ring Element. Implements {@link @microsoft/fast-foundation#BaseProgress},
   * {@link @microsoft/fast-foundation#progressRingTemplate}
   *
   *
   * @public
   * @remarks
   * HTML Element: \<sevolt-progress-ring\>
   */
  const sevoltProgressRing = ProgressRing.compose({
  ...
  /**
   * The Sevolt Radio Element. Implements {@link @microsoft/fast-foundation#Radio},
   * {@link @microsoft/fast-foundation#radioTemplate}
   *
   *
   * @public
   * @remarks
   * HTML Element: \<sevolt-radio\>
   */
  const sevoltRadio = Radio.compose({
    baseName: 'radio',
  ...
  /**
   * The Sevolt Radio Group Element. Implements {@link @microsoft/fast-foundation#RadioGroup},
   * {@link @microsoft/fast-foundation#radioGroupTemplate}
   *
   *
   * @public
   * @remarks
   * HTML Element: \<sevolt-radio-group\>
   */
  const sevoltRadioGroup = RadioGroup.compose({
  ...
  /**
   * The Sevolt Search Custom Element. Implements {@link @microsoft/fast-foundation#Search},
   * {@link @microsoft/fast-foundation#searchTemplate}
   *
   *
   * @public
   * @remarks
   * HTML Element: \<sevolt-search\>
   *
   * {@link https://developer.mozilla.org/en-US/docs/Web/API/ShadowRoot/delegatesFocus | delegatesFocus}
   */
  const sevoltSearch = Search.compose({
    baseName: 'search',
    baseClass: Search$1,
  ...
  /**
   * The Sevolt select Custom Element. Implements, {@link @microsoft/fast-foundation#Select}
   * {@link @microsoft/fast-foundation#selectTemplate}
   *
   *
   * @public
   * @remarks
   * HTML Element: \<sevolt-select\>
   *
   */
  const sevoltSelect = Select.compose({
    baseName: 'select',
    baseClass: Select$1,
  ...
  /**
   * The Sevolt Skeleton Element. Implements {@link @microsoft/fast-foundation#Skeleton},
   * {@link @microsoft/fast-foundation#skeletonTemplate}
   *
   *
   * @public
   * @remarks
   * HTML Element: \<sevolt-skeleton\>
   */
  const sevoltSkeleton = Skeleton.compose({
    baseName: 'skeleton',
  ...
  /**
   * The Sevolt Slider Custom Element. Implements {@link @microsoft/fast-foundation#(Slider:class)},
   * {@link @microsoft/fast-foundation#sliderTemplate}
   *
   *
   * @public
   * @remarks
   * HTML Element: \<sevolt-slider\>
   */
  const sevoltSlider = Slider.compose({
    baseName: 'slider',
  ...
  /**
   * The Sevolt Slider Label Custom Element. Implements {@link @microsoft/fast-foundation#SliderLabel},
   * {@link @microsoft/fast-foundation#sliderLabelTemplate}
   *
   *
   * @public
   * @remarks
   * HTML Element: \<sevolt-slider-label\>
   */
  const sevoltSliderLabel = SliderLabel.compose({
  ...
  /**
   * The Sevolt Switch Custom Element. Implements {@link @microsoft/fast-foundation#Switch},
   * {@link @microsoft/fast-foundation#SwitchTemplate}
   *
   *
   * @public
   * @remarks
   * HTML Element: \<sevolt-switch\>
   */
  const sevoltSwitch = Switch.compose({
    baseName: 'switch',
  ...
  /**
   * The Sevolt Tab Custom Element. Implements {@link @microsoft/fast-foundation#Tab},
   * {@link @microsoft/fast-foundation#tabTemplate}
   *
   *
   * @public
   * @remarks
   * HTML Element: \<sevolt-tab\>
   */
  const sevoltTab = Tab.compose({
    baseName: 'tab',
  ...
  /**
   * The Sevolt Tab Panel Custom Element. Implements {@link @microsoft/fast-foundation#TabPanel},
   * {@link @microsoft/fast-foundation#tabPanelTemplate}
   *
   *
   * @public
   * @remarks
   * HTML Element: \<sevolt-tab-panel\>
   */
  const sevoltTabPanel = TabPanel.compose({
    baseName: 'tab-panel',
  ...
  /**
   * The Sevolt Tabs Custom Element. Implements {@link @microsoft/fast-foundation#Tabs},
   * {@link @microsoft/fast-foundation#tabsTemplate}
   *
   *
   * @public
   * @remarks
   * HTML Element: \<sevolt-tabs\>
   */
  const sevoltTabs = Tabs.compose({
    baseName: 'tabs',
  ...
  /**
   * The Sevolt Text Area Custom Element. Implements {@link @microsoft/fast-foundation#TextArea},
   * {@link @microsoft/fast-foundation#textAreaTemplate}
   *
   *
   * @public
   * @remarks
   * HTML Element: \<sevolt-text-area\>
   *
   * {@link https://developer.mozilla.org/en-US/docs/Web/API/ShadowRoot/delegatesFocus | delegatesFocus}
   */
  const sevoltTextArea = TextArea.compose({
    baseName: 'text-area',
  ...
  /**
   * The Sevolt Text Field Custom Element. Implements {@link @microsoft/fast-foundation#TextField},
   * {@link @microsoft/fast-foundation#textFieldTemplate}
   *
   *
   * @public
   * @remarks
   * HTML Element: \<sevolt-text-field\>
   *
   * {@link https://developer.mozilla.org/en-US/docs/Web/API/ShadowRoot/delegatesFocus | delegatesFocus}
   */
  const sevoltTextField = TextField.compose({
    baseName: 'text-field',
  ...
  /**
   * The Sevolt toolbar class
   * @internal
   */
  class Toolbar extends Toolbar$1 {}
  /**
   * The Sevolt Toolbar Custom Element. Implements {@link @microsoft/fast-foundation#Toolbar},
   * {@link @microsoft/fast-foundation#toolbarTemplate}
   *
   *
   * @public
   * @remarks
   * HTML Element: \<sevolt-toolbar\>
   */
  const sevoltToolbar = Toolbar.compose({
    baseName: 'toolbar',
    baseClass: Toolbar$1,
  ...
  /**
   * The Sevolt Tooltip Custom Element. Implements {@link @microsoft/fast-foundation#Tooltip},
   * {@link @microsoft/fast-foundation#tooltipTemplate}
   *
   *
   * @public
   * @remarks
   * HTML Element: \<sevolt-tooltip\>
   */
  const sevoltTooltip = Tooltip.compose({
    baseName: 'tooltip',
    baseClass: Tooltip$1,
  ...
  /**
   * The Sevolt tree view Custom Element. Implements, {@link @microsoft/fast-foundation#TreeView}
   * {@link @microsoft/fast-foundation#treeViewTemplate}
   *
   *
   * @public
   * @remarks
   * HTML Element: \<sevolt-tree-view\>
   *
   */
  const sevoltTreeView = TreeView.compose({
    baseName: 'tree-view',
  ...
  /* The french fry background needs to be calculated based on the selected background state for this control.
      We currently have no way of changing that, so setting to accent-foreground-rest for the time being */''} background:${accentFillRest};border-radius:calc(${controlCornerRadius} * 1px)}::slotted(sevolt-tree-item){--tree-item-nested-width:1em;--expand-collapse-button-nested-width:calc(${heightNumber} * -1px)}`.withBehaviors(new DirectionalStyleSheetBehavior(ltr, rtl), forcedColorsStylesheetBehavior(css`
  ...
  /**
   * The Sevolt tree item Custom Element. Implements, {@link @microsoft/fast-foundation#TreeItem}
   * {@link @microsoft/fast-foundation#treeItemTemplate}
   *
   *
   * @public
   * @remarks
   * HTML Element: \<sevolt-tree-item\>
   *
   */
  const sevoltTreeItem = TreeItem.compose({
    baseName: 'tree-item',
  ...
  const allComponents = {
    ...
    sevoltAccordionItem,
    sevoltAnchor,
    sevoltAnchoredRegion,
    sevoltBadge,
    sevoltBreadcrumb,
    sevoltBreadcrumbItem,
    sevoltButton,
    sevoltCalendar,
    sevoltCard,
    sevoltCheckbox,
    ...
    sevoltDataGridCell,
    sevoltDataGridRow,
    sevoltDesignSystemProvider,
    sevoltDialog,
    sevoltDivider,
    sevoltFlipper,
    sevoltHorizontalScroll,
    sevoltListbox,
    sevoltOption,
    sevoltMenu,
    sevoltMenuItem,
